...
def blendDemo():
    ...
    # im1 = cv2.cvtColor(cv2.imread('carrots.png'), cv2.COLOR_BGR2RGB) / 255
    # im2 = cv2.cvtColor(cv2.imread('rabbit.jpg'), cv2.COLOR_BGR2RGB) / 255
    # mask = cv2.cvtColor(cv2.imread('rabbit-bw-02.jpg'), cv2.COLOR_BGR2RGB) / 255
